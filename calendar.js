(function() {
    ...
    function Calendar() {
        ...
        self.drawSelection = function () {
            ...
            var dayOffset = self.getDay(firstDay.getDay()) - 1;
        ...
        self.showMonth = function (date) {
            ...
            if (!!dateInfo) {
                ...
                for (var i = 0, maxI = $weekdays.length; i < maxI; i++) {
                    $weekdays.eq(self.getDay(i)).text(dateInfo.days.names.min[i]);
                }
            }
            ...
            for (var firstDay = self.getDay(date.clone().moveToFirstDayOfMonth().getDay()) - 1, lastDay = firstDay + date.clone().moveToLastDayOfMonth().getDate(), i = 0, maxI = $days.length; i < maxI; i++) {
